...
if __name__ == "__main__":
    ...
    OUTPUT_DIR = "D:\Software\PyCharm\PycharmProjects\DSTRformer-main\datasets/" + DATASET_NAME
    DATA_FILE_PATH = "D:\Software\PyCharm\PycharmProjects\DSTRformer-main\datasets/raw_data/{0}/{0}.npz".format(DATASET_NAME)
    GRAPH_FILE_PATH = "D:\Software\PyCharm\PycharmProjects\DSTRformer-main\datasets/raw_data/{0}/adj_{0}.pkl".format(DATASET_NAME)
